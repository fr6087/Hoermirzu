...
namespace LuisBot.Dialogs
{
    ...
    /// a certain action. The strings used in this class were generated by Microsoft's rview.exe tool. 
    ...
    public class BasicLuisDialog : LuisDialog<object>
    {
        ...
        {
            string luisno = Resource1.LuisNone;
        ...
        */
        ...
        private async Task FeedbackFormComplete(IDialogContext context, IAwaitable<ESF2CompanyDetailsForm> result)
        {
            ...
            await context.SayAsync(text:Resource1.Save, speak: Resource1.Save);
        ...
        private async Task MessageReceivedAsync(IDialogContext context, IAwaitable<IMessageActivity> argument)
        {
            ...
            if (message.Text.ToLower().Equals(Resource1.Yes))
            {
                ...
                await context.SayAsync(text: Resource1.Saved, speak: Resource1.Saved);
            }
            else
            {
        ...
        public async Task AfterDialog(IDialogContext context, IAwaitable<object> result)
        {
            ...
            await context.SayAsync(text: Resource1.GotHelpedQuestion, speak: Resource1.GotHelpedQuestion);
       ...
       ///is prompted. Since ListenToMe is using a dynamic webform with German, English and Polish, where the fields might change in the future, usage of this class is deprecated.
      ///ToDO search for alternatives
        ...
        public class ESF2CompanyDetailsForm
        {
            ...
            public static IForm<ESF2CompanyDetailsForm> BuildForm()
            {
             ...
             /// </summary>
             /// <returns>Localized IForm (that is changes the UI-Culture of the bot messages)</returns>
            ...
            /// <summary>
            /// calls an embedded ressource file for constructing the dialog. note that wcf service has a method JsonForBot that generates the json
            /// for the file. Sadly the author has not been clever enough to find a way to send this json from WCF Service to Bot automatically.
            /// As it is, it has to be copied manually.
            /// </summary>
            /// <returns></returns>
            public static IForm<JObject> BuildJsonForm()
            {
                Assembly assembly = Assembly.GetExecutingAssembly();
                string jsonFile = Resource1.JsonFile;
                ...
                using (stream)
                {
                    ...
                    return new FormBuilderJson(schema)
                        //.Message(Resource1.FormWelcomeMessage) //does not work for Cortana
                        .Build();
                }
            }
        }
