...
{
    /// <summary>
    /// Code Behind for a list of Sections, including an Add button. Associated with the 
    /// SectionListViewModel for most behaviors and properties.
    /// </summary>
    public sealed partial class SectionListView : Page
    {
        private NavigationHelper navigationHelper;

        private SectionListViewModel defaultViewModel;

        public SectionListViewModel DefaultViewModel
        {
        ...
        {
            defaultViewModel = (SectionListViewModel)this.DataContext;

            DefaultViewModel.SelectedSection = null;
        ...
        /// way to handle the SelectionChanged event, in order to open the selected Section's 
        /// details.
        /// </summary>
        /// <param name="sender">Ignored</param>
