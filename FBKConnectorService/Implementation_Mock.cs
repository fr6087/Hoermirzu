...
{
    /// <summary>
    /// provides methods for parsing dummy files. Use the methods of this class, when there is no internect connection, or some other
    /// reason why you might not be able to post / get request and / or answers from the Formularbaukasten website.
    /// </summary>
    public class Implementation_Mock : ServiceClass
    {
        ...
        {
            string pathFile = System.AppDomain.CurrentDomain.BaseDirectory + "Sections_"+language+".json";
        ...
        /// <summary>
        /// not implemented yet. method for posting fieldvalues from a client application (such as an app) back to the Formularbaukasten website.
        /// Talked with Kai about it, very likely that the Instanzservice that's written in Go has to be connected for this to work.
        /// </summary>
        /// <param name="section"></param>
        /// <returns></returns>
