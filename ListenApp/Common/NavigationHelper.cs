...
{
    /// <summary>
    /// aids in navigation between pages. It manages
    ...
    {
        /// <summary>
        /// the page that is used for initializing the class. In this case, MainPage
        /// </summary>
        private Page Page { get; set; }
        /// <summary>
        /// the frame that is used for initializing the class. In this case, the root frame.
        /// </summary>
    ...
    /// <summary>
    /// registers for standard mouse and keyboard
    /// shortcuts used to go back and forward. There should be only one
    /// instance of this class per view, and it should be associated with the
    /// root frame.
    /// </summary>
    /// <example>
    ...
    public class RootFrameNavigationHelper
    {
        ...
        /// </summary>
        /// <returns>whether or not the navigation failed</returns>
        ...
        /// <summary>
        /// overloads the BackRequestedEvent of the SystemNavigationManager.
        /// </summary>
        ...
        /// <summary>
        /// updates the Backbutton which may be visible on the screen or not. If there is no going back, it hides the goBack-Button
        /// </summary>
